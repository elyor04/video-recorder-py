...
# Install intel gpu driver and library (WARNING: if you don't have intel gpu, please comment 2 lines below)
...
sudo apt-get -y install build-essential cmake git pkg-config libgtk-3-dev \
    ...
    libopenexr-dev libjasper-dev libv4l-dev libxvidcore-dev \
    libx264-dev libatlas-base-dev gfortran python3-dev python3-pip
